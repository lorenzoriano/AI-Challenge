...
#tools/playgame.py -E --turntime=200 -O --player_seed 42 --end_wait=0.25 --log_dir game_logs --turns 1000 "python current_bot/MyBot.py" "python oldbot3/oldbot3.py" --fill --verbose --map_file tools/maps/random_walk/random_walk_02p_02.map
...
tools/playgame.py -E --turntime=400 -O --end_wait=0.25 --log_dir game_logs --turns 1000   "python current_bot/MyBot.py"  "python oldbot3/oldbot3.py"  --fill --verbose --map_file tools/maps/random_walk/random_walk_03p_02.map
